...
<main>
    <div class="container">
        <section class="section-stats row justify-content-center" id="stats">
            <div class="col-lg-3 col-md-3 stats-detail border">
                <h2>20K</h2>
                <p>Members</p>
            </div>
            <div class="col-lg-3 col-md-3 stats-detail border">
    ...
    <div class="section section-testimonial-content" id="testimonialContent">
        <div class="container">
            <div class="section-popular-teavel row justify-content-center">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="{{ url('frontend/images/user-1.jpg') }}" alt="User" class="mb-4 rounded-circle">
                            <h3 class="mb-4">Tony</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="{{ url('frontend/images/user-2.jpg') }}" alt="User" class="mb-4 rounded-circle">
                            <h3 class="mb-4">Babyla</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="{{ url('frontend/images/user-3.jpg') }}" alt="User" class="mb-4 rounded-circle">
                            <h3 class="mb-4">Thomas</h3>
